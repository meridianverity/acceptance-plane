...
```bash
python tools/verify_release_artifact.py acceptance-plane-v1_0_2-public-eval-hardened.zip \
  --sha256-file acceptance-plane-v1_0_2-public-eval-hardened.zip.sha256.txt

python tools/verify_proof_receipt.py \
  --verify-manifest \
  --release-zip acceptance-plane-v1_0_2-public-eval-hardened.zip \
  --sha256-file acceptance-plane-v1_0_2-public-eval-hardened.zip.sha256.txt
```
