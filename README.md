...
- `docs/zenodo-github-launch-runbook.md` - operational launch plan.
- `docs/ip-redline-checklist.md` - publish/hold-back checklist.
- `docs/glossary.md` - public vocabulary.
- `docs/faq.md` - category FAQ.
- `docs/publication-readiness-checklist.md` - final go/no-go gate.
- `figures/` - conceptual stack and workflow diagrams.
- `dist/` - PDF/DOCX release assets.
- `metadata/` - Zenodo/GitHub metadata and LinkedIn copy.
- `scripts/` - manifest verification helper script.
...
The GitHub release package is intended as a source/provenance package for public architecture materials, not a product software release.
